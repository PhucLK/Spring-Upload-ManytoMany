...
<html>
    ...
    <body>
        ...
        <div class="container">
            <h1 style="margin-top: 7%; margin-bottom: 5%; text-align: center;">List
                Product</h1>
                    ...
                    <table class="table table-hover">
                        ...
                        <c:forEach var="product" items="${ListProduct}">
                            <tr>
                                ...
                                <td>${product.price}</td>
                                <td><a
                                        href="<c:url value='editProduct/${product.id}'/>"><button
                                            class="btn btn-primary">Edit</button></a>
                                <td><a
                                        href="<c:url value='deleteProduct/${product.id}'/>"><button
